...
class SettingsMenu(Button):
    def __init__(self, window, screen):
        ...
        self.width = self.config.get("Graphics", "Screen_Width")
        self.height = self.config.get("Graphics", "Screen_Height")

        #reset background to white
        self.colour = pygame.Color('#ffffff')
        self.window.fill(self.colour)
        #make button
        self.font = pygame.font.Font("assets/fonts/OldeTome.ttf", 37)
        self.back_btn = self.create_rect((150, 120), (160, 60), '#ffffff', '#000000', "Back", self.font, 0, offset_y=4)
        self.front_font = pygame.font.Font("assets/fonts/OldeTome.ttf", 56)
        ...
        self.resolution_btn = self.create_rect((1920 / 2 + 175, 300), (200, 60), '#000000', '#000000', self.resolution, self.font, 5, offset_y=4)
